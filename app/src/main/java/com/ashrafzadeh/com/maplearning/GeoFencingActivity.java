...
public class GeoFencingActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, ResultCallback<Status> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addButton = (Button) findViewById(R.id.geobtn);
    ...
    public void addGeofencesButtonHandler() {
        if (!mGoogleApiClient.isConnected()) {
           ...
           // Toast.makeText(this, "Client is Ready", Toast.LENGTH_SHORT).show();
        }
